...
from src.exception_handlers.stream_exception import StreamNotFoundException, InvalidStreamStateException
...
class DonationService:
    ...
    async def get_donation_by_stream_id(self, stream_id: UUID) -> list[DonationResponse]: 
        stream = await self.stream_repo.get(id=stream_id)
